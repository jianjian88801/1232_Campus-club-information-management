...
public class JiarushetuanController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,JiarushetuanEntity jiarushetuan,
     ...
     */
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,JiarushetuanEntity jiarushetuan, 
		HttpServletRequest request){
        EntityWrapper<JiarushetuanEntity> ew = new EntityWrapper<JiarushetuanEntity>();
		PageUtils page = jiarushetuanService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, jiarushetuan), params), params));
        return R.ok().put("data", page);
    ...
    public R update(@RequestBody JiarushetuanEntity jiarushetuan, HttpServletRequest request){
        //ValidatorUtils.validateEntity(jiarushetuan);
        jiarushetuanService.updateById(jiarushetuan);//全部更新
        return R.ok();
    }
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<JiarushetuanEntity> wrapper = new EntityWrapper<JiarushetuanEntity>();
		if(map.get("remindstart")!=null) {
